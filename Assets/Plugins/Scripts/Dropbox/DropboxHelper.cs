...
namespace Plugins.Scripts.Dropbox
{
    public static class DropboxHelper
    {
        ...
        private const string AppKey = "mk1ozjv1n4r3hb2";
        private const string AppSecret = "ptr0xsj6dqy75zq";
        ...
        private const string AuthCode = "QmbYJqqNRDsAAAAAAAAC7Y4neYXkwwPY7ErWDuWRdVg";
#endif

        // paste from GetRefreshToken() result, value of "refresh_token"
        private const string RefreshToken = "bcfVHIX18GEAAAAAAAAAAafyT5KZWY1waDuIse84AB8DhWF3rxXyC1q5k3d-twpl";
